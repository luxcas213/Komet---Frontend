      ...
      <div className="space-y-3 text-sm">
        ...
        <div className="mt-4 pt-3 border-t border-gray-600">
          ...
          <div className="space-y-2">
            ...
            <Link 
              href={`/simulation/consecuencias/${asteroid.id}`}
              className="block w-full text-center bg-green-600 hover:bg-green-700 text-white font-semibold py-2 px-4 rounded transition-colors duration-200 group-hover:bg-green-500"
            >
              <span className="flex items-center justify-center gap-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
